          ...
          <div className="w-full h-[550px] text-white overflow-hidden">
            <div className="w-full h-full ">
              ...
              <div className="absolute top-[20%] p-2 md:p-6">
                <h3 className="text-3xl md:5xl font-bold  max-sm:text-xl">
                  {moive?.title}
                </h3>
                <div className="py-4">
                  <Link to={`moviedateils/${moive?.id}`}>
                    <button className="border-none py-2 px-5 max-sm:text-[10px]  bg-white rounded text-black capitalize mr-4">
                      play
                    </button>
                  </Link>
                  <button className="border rounded py-2 px-5 max-sm:text-[10px]  capitalize bg-transparent">
                    watch later
                  </button>
                </div>
                ...
                <div className="text-lg capitalize max-md:text-sm w-full md:max-w-[60%] max-sm:max-w-[50%]  max-sm:text-sm  text-gray-200 max-md:max-w-[35%]">
                  {moive?.overview}
                </div>
              </div>
            </div>
